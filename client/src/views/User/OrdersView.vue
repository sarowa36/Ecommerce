...
import { OrderValue, OrderItemComponent } from "@/components/orderItemComponent";
...
<template>
    <DashboardLayout>
        <div class="row pt-5">
            <OrderItemComponent v-for="(item, key) in orders" v-model="orders[key]" v-bind:key="key"></OrderItemComponent>
