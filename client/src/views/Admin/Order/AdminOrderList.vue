...
import { OrderItemComponent, OrderStatus,OrderStatusDescriber, OrderValue } from '@/components/orderItemComponent';
...
<template>
    <DashboardLayout>
            ...
            <OrderItemComponent v-for="(item,index) in orders" v-model="orders[index]" :key="index"></OrderItemComponent>
